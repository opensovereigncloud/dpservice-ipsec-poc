...
func Encryption(factory DPDKClientFactory) *cobra.Command {
	...
	subcommands := []*cobra.Command{
		EncryptionEnable(factory, rendererOptions),
		EncryptionDisable(factory, rendererOptions),
		EncryptionGet(factory, rendererOptions),
	}
