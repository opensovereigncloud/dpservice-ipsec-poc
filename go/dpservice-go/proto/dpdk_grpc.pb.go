...
func (c *dPDKironcoreClient) CreateSecurityAssociation(ctx context.Context, in *CreateSecurityAssociationRequest, opts ...grpc.CallOption) (*CreateSecurityAssociationResponse, error) {
	out := new(CreateSecurityAssociationResponse)
	err := c.cc.Invoke(ctx, "/dpdkironcore.v1.DPDKironcore/CreateSecurityAssociation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dPDKironcoreClient) DeleteSecurityAssociation(ctx context.Context, in *DeleteSecurityAssociationRequest, opts ...grpc.CallOption) (*DeleteSecurityAssociationResponse, error) {
	out := new(DeleteSecurityAssociationResponse)
	err := c.cc.Invoke(ctx, "/dpdkironcore.v1.DPDKironcore/DeleteSecurityAssociation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDPDKironcoreServer) CreateSecurityAssociation(context.Context, *CreateSecurityAssociationRequest) (*CreateSecurityAssociationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateSecurityAssociation not implemented")
}
...
func _DPDKironcore_CreateSecurityAssociation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSecurityAssociationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DPDKironcoreServer).CreateSecurityAssociation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dpdkironcore.v1.DPDKironcore/CreateSecurityAssociation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DPDKironcoreServer).CreateSecurityAssociation(ctx, req.(*CreateSecurityAssociationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DPDKironcore_DeleteSecurityAssociation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteSecurityAssociationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DPDKironcoreServer).DeleteSecurityAssociation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dpdkironcore.v1.DPDKironcore/DeleteSecurityAssociation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DPDKironcoreServer).DeleteSecurityAssociation(ctx, req.(*DeleteSecurityAssociationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DPDKironcore_GetSecurityAssociation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(DPDKironcoreServer).GetSecurityAssociation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dpdkironcore.v1.DPDKironcore/GetSecurityAssociation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DPDKironcoreServer).GetSecurityAssociation(ctx, req.(*GetSecurityAssociationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DPDKironcore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateSecurityAssociation",
			Handler:    _DPDKironcore_CreateSecurityAssociation_Handler,
		},
		{
